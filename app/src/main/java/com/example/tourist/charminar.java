...
public class charminar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.charminar);
        ...
        button.setOnClickListener(new charminar.clik());
        button2.setOnClickListener(new charminar.clik());
        button3.setOnClickListener(new charminar.clik());
        button4.setOnClickListener(new charminar.clik());
        button5.setOnClickListener(new charminar.clik());
        button6.setOnClickListener(new charminar.clik());
        button7.setOnClickListener(new charminar.clik());
    }
