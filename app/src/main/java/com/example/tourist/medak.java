...
public class medak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new medak.clik());
        button2.setOnClickListener(new medak.clik());
        button3.setOnClickListener(new medak.clik());
        button4.setOnClickListener(new medak.clik());
        button5.setOnClickListener(new medak.clik());
        button6.setOnClickListener(new medak.clik());
        button7.setOnClickListener(new medak.clik());
    }
