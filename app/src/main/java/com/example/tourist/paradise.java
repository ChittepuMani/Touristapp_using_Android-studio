...
public class paradise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new paradise.clik());
        button2.setOnClickListener(new paradise.clik());
        button3.setOnClickListener(new paradise.clik());
        button4.setOnClickListener(new paradise.clik());
        button5.setOnClickListener(new paradise.clik());
        button6.setOnClickListener(new paradise.clik());
        button7.setOnClickListener(new paradise.clik());
    }
