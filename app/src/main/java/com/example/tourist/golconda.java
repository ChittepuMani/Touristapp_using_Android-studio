...
public class golconda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new golconda.clik());
        button2.setOnClickListener(new golconda.clik());
        button3.setOnClickListener(new golconda.clik());
        button4.setOnClickListener(new golconda.clik());
        button5.setOnClickListener(new golconda.clik());
        button6.setOnClickListener(new golconda.clik());
        button7.setOnClickListener(new golconda.clik());
    }
